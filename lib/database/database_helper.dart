...
class DatabaseHelper {
  ...
  void _onCreate(Database db, int version) async {
    await db.execute(
        "CREATE TABLE User(id INTEGER PRIMARY KEY, fname TEXT, lname TEXT, email TEXT, phone TEXT, password TEXT, flaglogged TEXT)");
  ...
  Future<User> selectUser(User user) async{
    ...
    List<Map> maps = await dbClient.query(tableUser,
        columns: [columnfName, columnlName, columnUserEmail, columnUserPhone, columnPassword],
